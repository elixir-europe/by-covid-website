 ...
 */
 ...
 exports.onCreateNode = ({ node, actions, getNode }) => {
   ...
   if (node.internal.type === "Mdx") {
     ...
     else if(node.frontmatter.postType === 'UsecaseNl') {
      createNodeField({
        // Name of the field you are adding
        name: "slug",
        // Individual MDX node
        ...
        // don't need a separating "/" before the value because
        // createFilePath returns a path with the leading "/".
        value: `/usecases-nl${value}`,
      })
     }
     else if(node.frontmatter.postType === 'UsecaseDe') {
      createNodeField({
        // Name of the field you are adding
        name: "slug",
        // Individual MDX node
        ...
        // don't need a separating "/" before the value because
        // createFilePath returns a path with the leading "/".
        value: `/usecases-de${value}`,
      })
     }
     else if(node.frontmatter.postType === 'UsecaseEs') {
      createNodeField({
        // Name of the field you are adding
        name: "slug",
        // Individual MDX node
        ...
        // don't need a separating "/" before the value because
        // createFilePath returns a path with the leading "/".
        value: `/usecases-es${value}`,
      })
     }
     else if(node.frontmatter.postType === 'UsecaseIt') {
      createNodeField({
        // Name of the field you are adding
        name: "slug",
        // Individual MDX node
   ...
   posts.forEach(({ node }, index) => {
     ...
     if(node.frontmatter.postType === 'Usecase'){
      ...
      createPage({
        ...
        path: node.fields.slug,
        // This component will wrap our MDX content
        component: path.resolve(`./src/components/usecases-layout-nl.js`),
        // You can use the values in this context in
        // our page layout component
        context: { id: node.id },
      })
      ...
      createPage({
        ...
        path: node.fields.slug,
        // This component will wrap our MDX content
        component: path.resolve(`./src/components/usecases-layout-de.js`),
        // You can use the values in this context in
        // our page layout component
        context: { id: node.id },
      })
      ...
      createPage({
        ...
        path: node.fields.slug,
        // This component will wrap our MDX content
        component: path.resolve(`./src/components/usecases-layout-es.js`),
        // You can use the values in this context in
        // our page layout component
        context: { id: node.id },
      })
      ...
      createPage({
        ...
        path: node.fields.slug,
        // This component will wrap our MDX content
        component: path.resolve(`./src/components/usecases-layout-it.js`),
        // You can use the values in this context in
        // our page layout component
        context: { id: node.id },
      })
