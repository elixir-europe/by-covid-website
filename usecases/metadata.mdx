...
Metadata is "data about data". However, not all metadata is useful, and standards need to be agreed by the research community and ideally follow a set of guidelines called the [FAIR principles](https://docs.google.com/document/d/1Ep88EgejFTC-M8VYj9hncmbKgLk6ci_1H4g_glLNeMU/edit). Metadata standards assist with the creation of metadata catalogues to make data findable and accessible, and can serve also as adapters to make data interoperable and reusable. 
