...
F: Findable. Scientists must find the data they need. The more information about a dataset ([metadata](https://docs.google.com/document/d/1gaIr0vf_DWriQLseD-M5zrIH1m4jyP8LeD8nVL0NEsI/edit), which also need to be standardised) is available the easier it can be found.
