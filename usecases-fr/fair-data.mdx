...
F : Findable (Trouvable). Les scientifiques doivent trouver les données dont ils ont besoin. Plus les informations sur un ensemble de données ([métadonnées](../metadata), qui doivent également être standardisées) sont disponibles, plus il est facile de les trouver.  <br /><br />
