    ...
    <Container>
      <Row>
       ...
       <Row className="justify-content-md-center">
        ...
        <p class="mt-4 fs-5 text-center">The Work Packages will <strong>mobilise</strong> SARS-CoV-2 and other infectious disease data (i.e. make it easier to transfer to a data repository), <strong>connect</strong> and <strong>standardise</strong> the data (to make data searchable via the <a href="https://www.covid19dataportal.org/">COVID-19 Data Portal</a> and provide data management protocols), and <strong>expose and analyse the data</strong> (provide standardised analysis methods).</p>
         </Col>
        </Row>
     </Container>
