    ...
    <>
      ...
      <Container>
       <Row>
        ...
        <Col>
          <h2 class="mb-2 fs-6 fw-bold "><Link to="/about" className="text-light">About</Link></h2>
          <ul class="list-unstyled fs-7 lh-xlg">
        ...
        <Col>
          <h2 class="mb-2 fs-6 fw-bold"><Link to="/outcomes" className="text-light">Outcomes</Link></h2>
          <ul class="list-unstyled fs-7 lh-xlg">
        ...
        <Col>
          <h2 class="mb-2 fs-6 fw-bold"><Link to="/outreach-media" className="text-light">Outreach & media</Link></h2>
          <ul class="list-unstyled fs-7 lh-xlg">
       ...
       <Row className="pt-5 no-gutters">
         <Col xs={6}>
              <img src={euIcon} alt="EU icon" width="40" class="float-start mt-1 me-3"/>
         ...
         <Col>
         <div class="mx-auto">
         <ul class="list-unstyled fs-7 lh-lg mx-auto w-50">
         ...
         <Col>
           <div class="text-center pe-4">
              <a href="linkedin.html" class="d-inline-block"><img src={linkedinIcon} alt="LinkedIn icon" width="45"/></a>
              <a href="linkedin.html" class="d-inline-block ms-3"><img src={twitterIcon} alt="Twitter icon" width="45"/></a>
              <a href="linkedin.html" class="d-inline-block ms-4"><img src={youTubeIcon} alt="YouTube icon" width="45"/></a>
            </div>
         </Col>
        </Row>
      </Container>
