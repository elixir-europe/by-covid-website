---
title: BY-COVID
description: The BeYond-COVID (BY-COVID) project aims to provide open data on SARS-CoV-2 and other infectious diseases across scientific, medical and public health domains.
class: home
...
<div class="text-center survey-box">
<h2 class="mt-4 small-size">BY-COVID industry event - 24 January 2023</h2>
  <div class="survey-text">
    
    <p>Join the BY-COVID industry community in the upcoming event with a focus on Data driven innovation for combating infectious diseases - Better data management for better pandemic preparedness, disease surveillance and outbreak control.</p>
    <button class="btn btn-primary" onClick={()=>{navigate("https://by-covid.org/news-events/by-covid-accessday/")}}>View industry event</button>
  </div>
</div>
...
<Container className="lh-sm data-sources big-top-space">
  <Row>
    ...
    <Col className="data-source medical">Medical Centres</Col>
    <Col className="data-source public">Public Health Laboratories</Col>
    <Col className="data-source research-infrastructures">
      Research Infrastructures
    </Col>
    <Col className="data-source universities">Universities</Col>
  </Row>
  <Row>
    <Col className="data-source consortia">Consortia</Col>
    <Col className="data-source research-centres">Research Centres</Col>
  </Row>
</Container>
...
<div class="what-doing-boxes">
  ...
  <div class="box box3 bg-white text-body">
    <h3 class="fs-6 fw-bold mb-1 bg-white text-primary">
...
<div class="bg-semi-opaque container full-width big-top-space text-body px-4">

<Container className="twitter">
  <Row>
    <Col className="align-items-stretch mb-4 mb-md-0" xs={12} sm={6} lg={8}>
      <Card className="mb-4">
      ...
      <Card className="mb-4">
       ...
       <Card className="mb-4">
        <Card.Body className="position-relative">
          ...
          <div class="bottom-link-right arrow-right">
            <Link to="/outreach-media">Outreach & media</Link>
          </div>
        </Card.Body>
      </Card>
