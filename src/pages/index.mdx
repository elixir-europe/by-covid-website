...
<h2 class="mt-4">Industry Survey</h2>
  <div class="survey-text">
    
    <p>Join the BY-COVID industry community and engage in our upcoming industry-related activities, please fill in our survey.</p>
...
<Container className="twitter">
  <Row>
    <Col className="align-items-stretch mb-4 mb-md-0" xs={12} sm={6} lg={7}>
      <Card className="mb-4">
    ...
    <Col className="align-items-stretch mb-4 mb-md-0" xs={12} sm={6} lg={5}>
      <Card className="mb-4 home-twitter-box">
