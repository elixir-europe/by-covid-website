          ...
          <Col className="px-0">
            ...
            <main>
              <article id="content">
                  ...
                  <Row>
                    <Col>
                      ...
                      <div class="position-relative social-media">
                        <div class="form">
                          <p class="mb-1 fs-6">
                            Select the language: <Link to="/usecases">English</Link> | <Link to="/usecases-fr">Français</Link> | <Link to="/usecases-cz">Czech</Link> | <Link to="/usecases-nl"><strong>Dutch</strong></Link> | <Link to="/usecases-de">German</Link> | <Link to="/usecases-es">Spanish</Link> | <Link to="/usecases-it">Italian</Link>
                          </p>
                        </div>
                      </div>
                    </Col>
                ...
                <p className="text-center">
                Welk verschil zal het BY-COVID-project maken en wat betekent het voor burgers? Bekijk de onderstaande voorbeelden voor meer informatie.
</p>
                </Col>
                </Row>
                  <Row>
...
export const pageQuery = graphql`
  query useCaseListIndexnl {
    allMdx(
      filter: { frontmatter: { postType: { eq: "UsecaseNl" } } }
