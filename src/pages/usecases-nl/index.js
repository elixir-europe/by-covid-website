                  ...
                  <Row>
                    <Col>
                      ...
                      <div class="position-relative social-media">
                        <div class="form">
                          <p class="mb-1 fs-6">
                            Select the language: <Link to="/usecases">English</Link> | <Link to="/usecases-fr">Français</Link> | <Link to="/usecases-cz">Czech</Link> | <Link to="/usecases-nl"><strong>Dutch</strong></Link>
                          </p>
                        </div>
                      </div>
                    </Col>
