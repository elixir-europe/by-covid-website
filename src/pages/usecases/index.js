                  ...
                  <Row>
                    <Col>
                      ...
                      <div class="position-relative social-media">
                        <div class="form">
                          <p class="mb-1 fs-6">
                            Select the language: <Link to="/usecases"><strong>English</strong></Link> | <Link to="/usecases-fr">Français</Link> | <Link to="/usecases-cz">Czech</Link> | <Link to="/usecases-nl">Dutch</Link> | <Link to="/usecases-de">German</Link> | <Link to="/usecases-es">Spanish</Link>
                          </p>
                        </div>
                      </div>
                    </Col>
