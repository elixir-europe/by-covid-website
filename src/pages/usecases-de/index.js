          ...
          <Col className="px-0">
            ...
            <main>
              <article id="content">
                  ...
                  <Row>
                    <Col>
                      ...
                      <div class="position-relative social-media">
                        <div class="form">
                          <p class="mb-1 fs-6">
                            Select the language: <Link to="/usecases">English</Link> | <Link to="/usecases-fr">Français</Link> | <Link to="/usecases-cz">Czech</Link> | <Link to="/usecases-nl">Dutch</Link> | <Link to="/usecases-de"><strong>German</strong></Link> | <Link to="/usecases-es">Spanish</Link> | <Link to="/usecases-it">Italian</Link>
                          </p>
                        </div>
                      </div>
                    </Col>
                ...
                <p className="text-center">
                Welchen Unterschied wird das BY-COVID-Projekt machen und was bedeutet das für die Bürger? Sehen Sie sich die folgenden Beispiele an, um mehr zu erfahren.
</p>
                </Col>
                </Row>
                  <Row>
...
export const pageQuery = graphql`
  query useCaseListIndex {
    allMdx(
      filter: { frontmatter: { postType: { eq: "UsecaseDe" } } }
