          ...
          <Col className="px-0">
            ...
            <main>
              <article id="content">
                  ...
                  <Row>
                    <Col>
                      ...
                      <div class="position-relative social-media">
                        <div class="form">
                          <p class="mb-1 fs-6">
                            Select the language: <Link to="/usecases">English</Link> | <Link to="/usecases-fr">Français</Link> | <Link to="/usecases-cz"><strong>Czech</strong></Link> | <Link to="/usecases-nl">Dutch</Link> | <Link to="/usecases-de">German</Link> | <Link to="/usecases-es">Spanish</Link> | <Link to="/usecases-it">Italian</Link>
                          </p>
                        </div>
                      </div>
                    </Col>
                ...
                <p className="text-center">
                Jaký rozdíl přinese projekt BY-COVID a co to znamená pro občany? Prozkoumejte níže uvedené příklady a zjistěte více.
</p>
                </Col>
                </Row>
                  <Row>
