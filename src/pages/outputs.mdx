     ...
     <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://doi.org/10.1016/j.nbt.2023.09.006"  aria-label="Read the paper in the ScienceDirect journal">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://bmcmedresmethodol.biomedcentral.com/articles/10.1186/s12874-023-02068-3"  aria-label="Read the paper in the BMC">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://zenodo.org/records/10069940"  aria-label="Read the paper in the Zenodo">
            Read more
            </a></div>
          </Card.Body>
      </Card>
      ...
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://www.mdpi.com/2076-2607/11/9/2251"  aria-label="Read the paper in the MDPI">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://datascience.codata.org/articles/10.5334/dsj-2023-035"  aria-label="Read the paper in the data science journal">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://zenodo.org/record/8338931"  aria-label="Read the paper in Zenodo">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://doi.org/10.3390%2Fv15091843"  aria-label="Read the paper in open science">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://assets.researchsquare.com/files/rs-3159433/v1/59d366f4-0f0e-44fd-82a2-c72488b25c9b.pdf"  aria-label="Read the paper in research square">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://onlinelibrary.wiley.com/doi/10.1002/lrh2.10365"  aria-label="Read the paper in online library">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://academic.oup.com/bioinformaticsadvances/article/3/1/vbad045/7100349"  aria-label="Read the paper in the Oxford academic">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://doi.org/10.1002/lrh2.10365"  aria-label="Read the paper in Wiley online library">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://www.nature.com/articles/s42003-023-04784-4"  aria-label="Read the paper in nature">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://zenodo.org/record/7867780"  aria-label="Read the paper in Zenodo">
            Read more
            </a></div>
          </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
            ...
            <div class="bottom-link"><a href="https://doi.org/10.1101/2022.11.03.515010"  aria-label="Read the paper in bioRxiv">
            Read more
            </a></div>
          </Card.Body>
      </Card>
  ...
  <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
          ...
          <div class="bottom-link"><a href="https://doi.org/10.1038/s41598-022-21953-3"  aria-label="Read the paper in Nature">
           Read more
          </a></div>
        </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-4 h-100">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.3897/rio.8.e94501" aria-label="Read the paper in Research Ideas and Outcomes">
          Read more
        </a></div>
      </Card.Body>
      </Card>
 ...
 <Row className="mt-4">
  <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
    <Card className="mb-4 mt-4 h-100">
        <Card.Body className="position-relative">
          ...
          <div class="bottom-link"><a href="https://doi.org/10.3897/rio.8.e93937"  aria-label="Read the paper in Research Ideas and Outcomes">
           Read more
          </a></div>
        </Card.Body>
      </Card>
  ...
  <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
    <Card className="mb-4 mt-4 h-100">
      <Card.Body className="position-relative">
          ...
          <div class="bottom-link"><a href="https://doi.org/10.1128/spectrum.02893-22"  aria-label="Read the paper in Mycobacteriology Spectrum">
           Read more
          </a></div>
        </Card.Body>
    </Card>
  ...
  <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
    <Card className="mb-4 mt-4 h-100">
      <Card.Body className="position-relative">
          ...
          <div class="bottom-link"><a href="https://doi.org/10.5281/zenodo.7696634"  aria-label="Read the preprint in Zenodo">
           Read more
          </a></div>
        </Card.Body>
    </Card>
    ...
    <Card className="mb-4 mt-4 h-100">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.1002/anie.202205858" aria-label="Read the paper in Angewandte Chemie">
          Read more
        </a></div>
      </Card.Body>
      </Card>
  ...
  <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
    <Card className="mb-4 mt-5 h-100">
        <Card.Body className="position-relative">
          ...
          <div class="bottom-link"><a href="https://doi.org/10.1038/s41597-022-01537-6"  aria-label="Read the paper in Scientific Data">
           Read more
          </a></div>
        </Card.Body>
      </Card>
    ...
    <Col className="align-items-stretch"  xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-5 h-100">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.5281/zenodo.7572373" aria-label="Read the specifiction in Zenodo">
          Read more
        </a></div>
      </Card.Body>
      </Card>
  ...
  <Col className="align-items-stretch" xs={12} sm={12} lg={6}>
    <Card className="mb-4 mt-4 h-100">
      <Card.Body className="position-relative">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.48550/arXiv.2205.12098" aria-label="Read the preprint at arXiv">
          Read more
        </a></div>
      </Card.Body>
    </Card>
    ...
    <Card className="mb-4 mt-4 h-100">
      <Card.Body className="position-relative">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.1093/molbev/msac061" aria-label="Molecular Biology and Evolution">
          Read more
        </a></div>
      </Card.Body>
    </Card>
  ...
  <Col className="align-items-stretch"  xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-5 h-100">
       <Card.Body className="position-relative">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.6084/m9.figshare.17125394.v1" aria-label="Read the report in Figshare">
          Read more
        </a></div>
      </Card.Body>
      </Card>
  ...
  <Col className="align-items-stretch"  xs={12} sm={12} lg={6}>
      <Card className="mb-4 mt-5 h-100">
        ...
        <div class="bottom-link"><a href="https://doi.org/10.1038/s41587-021-01069-1" aria-label="Read the paper in Nature Biotechnology">
          Read more
        </a></div>
      </Card.Body>
      </Card>
   ...
   <Table striped bordered>
    ...
    <tbody>
      ...
      <tr>
        <td>D2.2</td>
        <td>06/23</td>
        <td><a href="https://www.zenodo.org/record/8101848" aria-label="Read the deliverable in Zenodo" target="_blank">Data Access and Transfer across research domains and jurisdictions</a></td>
        <td>WP2</td>
      </tr>
      <tr>
        <td>D1.2</td>
      ...
      <tr>
        <td>D3.3.1</td>
        <td>09/23</td>
        <td><a href="https://doi.org/10.5281/zenodo.8386828" aria-label="Read the deliverable in Zenodo" target="_blank">COVID-19 Data Portal</a></td>
        <td>WP3</td>
      </tr>
      <tr>
        <td>D7.3</td>
        <td>09/23</td>
        <td><a href="https://doi.org/10.5281/zenodo.8405780" aria-label="Read the deliverable in Zenodo" target="_blank">Report on public engagement activities</a></td>
        <td>WP7</td>
      </tr>
      <tr>
        <td>D5.3</td>
