   ...
   <Table striped bordered>
    ...
    <tbody>
      ...
      <tr>
        <td>D8.2.3</td>
        <td>07/24</td>
        <td><a href="https://zenodo.org/records/13349254" aria-label="Read the deliverable in Zenodo" target="_blank">Project Data Management Plan initial release and periodic updates</a></td>
        <td>WP8</td>
      </tr>
      <tr>
        <td>D8.3</td>
