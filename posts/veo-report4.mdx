...
In its [eleventh report](http://localhost:8000/pdf/VEO-COVID-19-Variants-Report-11-Final.pdf) to the European Commission, VEO Consortium members summarize mobilisation and analysis of SARS-CoV-2 sequence data submitted to the European COVID-19 Data Platform in the context of the VEO project, which aims to develop tools and data analytics for pandemic and outbreak preparedness.
